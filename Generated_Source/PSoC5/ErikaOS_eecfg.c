 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_fader) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_glower) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_sevenSegment) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_fader*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_glower*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_sevenSegment*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_fader);
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_glower);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(tsk_sevenSegment);
    #endif
    #if EE_MAX_TASK > 6
    DeclareTask(Task_7);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_fader */
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_glower */
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread tsk_sevenSegment */
    #endif
    #if EE_MAX_TASK > 6
    ...
    #endif
    #if EE_MAX_EVENT > 1
        ,"ev_start_calculation"
    #endif
    #if EE_MAX_EVENT > 2
        ,"ev_stop_calc_correct"
    #endif
    #if EE_MAX_EVENT > 3
         ,"ev_stop_calc_incorrect"
    #endif
    #if EE_MAX_EVENT > 4
         ,"ev_stop_calc_timeout"
    #endif
    #if EE_MAX_EVENT > 5
         ,"ev_restart_game"
    #endif
