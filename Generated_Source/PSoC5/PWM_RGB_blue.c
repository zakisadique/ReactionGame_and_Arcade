...
void PWM_RGB_blue_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_RGB_blue_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_RGB_blue_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_RGB_blue_CAPTURE_LSB_PTR));
    }
...
void PWM_RGB_blue_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_RGB_blue_PERIOD_LSB_PTR, period);
    #endif /* (PWM_RGB_blue_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_RGB_blue_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_RGB_blue_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_RGB_blue_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_RGB_blue_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_RGB_blue_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_RGB_blue_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_RGB_blue_COMPARE1_LSB_PTR));
        #endif /* (PWM_RGB_blue_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_RGB_blue_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_RGB_blue_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_RGB_blue_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_RGB_blue_PERIOD_LSB_PTR));
    #endif /* (PWM_RGB_blue_UsingFixedFunction) */
}
